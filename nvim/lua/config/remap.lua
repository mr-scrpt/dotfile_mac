...
vim.api.nvim_set_keymap('n', '<S-Up>', ":call search('{', 'b')<CR>zz", { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<S-Down>', ":call search('}')<CR>zz", { noremap = true, silent = true })
vim.api.nvim_set_keymap('v', '<S-Up>',":call search('{', 'b')<CR>zz", { noremap = true, silent = true })
...
--
--
vim.api.nvim_set_keymap('n', '[[' , ":silent! eval search('{', 'b')<CR>w99[{" , { noremap = true })
vim.api.nvim_set_keymap('n', ']]' , ":silent! eval search('}')<CR>b99]}" , { noremap = true })
vim.api.nvim_set_keymap('n', '][' , "j0[[%:silent! eval search('{')<CR>" , { noremap = true })
vim.api.nvim_set_keymap('n', '[]' , "k$][%:silent! eval search('}', 'b')<CR>" , { noremap = true })
